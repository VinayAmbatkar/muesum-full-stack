...
const Booking = () => {
    ...
    const bookBooking = async () => {
        ...
        try {
            ...
            const { data } = await axios.post(backendUrl + '/api/user/book-Booking', { docId, slotDate, slotTime }, { headers: { token } })
            if (data.success) {
        ...
        <div>
            ...
            <div className='flex flex-col sm:flex-row gap-4'>
                ...
                <div className='flex-1 border border-[#ADADAD] rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
                    ...
                    <p className='text-gray-600 font-medium mt-4'>Booking fee: <span className='text-gray-800'>{currencySymbol}{docInfo.fees}</span> </p>
                </div>
            </div>
            ...
            <div className='sm:ml-72 sm:pl-4 mt-8 font-medium text-[#565656]'>
                ...
                <button onClick={bookBooking} className='bg-primary text-white text-sm font-light px-20 py-3 rounded-full my-6'>Book an Booking</button>
            </div>

            {/* Listing Releated Museums */}
            <RelatedMuseums speciality={docInfo.speciality} docId={docId} />
        </div>
    ) : null
}
